...
SUCCESS_LEFT = Response(
    {'Success': 'Left room successfully', }, status=status.HTTP_202_ACCEPTED)
SUCCESS_UPDATED = Response(
    {'Success': 'Room settings were updated successfully'}, status=status.HTTP_202_ACCEPTED)
