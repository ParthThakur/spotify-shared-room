...
class Room(models.Model):
    code = models.CharField(max_length=32, default=generate_unique_code, unique=True, primary_key=True)
...
class User(models.Model):
    code = models.CharField(max_length=32, default=generate_unique_code, primary_key=True)
